// POST /api/report-review-date — 리포트 배치일 확인 상태 토글. body: { batch_date | batch_dates[], reviewed }
// reviewed=true 면 report_batch_review 에 upsert(확인 완료), false 면 삭제(미확인). /api/review-date 미러.
